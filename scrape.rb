...
tba = new TBA("erikboesen:firstmap_scraper:v0.1")
...
loop do
	...
	if page.length > 0
        ...
        puts "Page #{pages} doesn't exist. We're done here. Moving on to location fetching."
        break
    end
end
...
teams.each_with_index { |team, i| locations.push(tba.get_team(team).location) }
puts locations
